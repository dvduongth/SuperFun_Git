	...
	this.Draw = function () {
		if (shouldDraw) {
			...
			if(instance.m_HP > OBSTACLE_HP * 0.75)
				...
				g_graphicEngine.DrawFast (g_context, imgBrick[1], instance.m_x * BLOCK_SIZE + g_gsActionPhase.m_screenShakeX, instance.m_y * BLOCK_SIZE + g_gsActionPhase.m_screenShakeY);
			else if(instance.m_HP > OBSTACLE_HP * 0.25)
				g_graphicEngine.DrawFast (g_context, imgBrick[2], instance.m_x * BLOCK_SIZE + g_gsActionPhase.m_screenShakeX, instance.m_y * BLOCK_SIZE + g_gsActionPhase.m_screenShakeY);
			else if(instance.m_HP > 0)
				g_graphicEngine.DrawFast (g_context, imgBrick[3], instance.m_x * BLOCK_SIZE + g_gsActionPhase.m_screenShakeX, instance.m_y * BLOCK_SIZE + g_gsActionPhase.m_screenShakeY);
			else
				g_graphicEngine.DrawFast (g_context, imgBrick[4], instance.m_x * BLOCK_SIZE + g_gsActionPhase.m_screenShakeX, instance.m_y * BLOCK_SIZE + g_gsActionPhase.m_screenShakeY);
		}
	}
}