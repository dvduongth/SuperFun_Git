 ...
 */
function NodeWS_Server(secure, options, callback) {
	var that = this;
	...
	var onConnection = function (socket) {
		var conn = new NodeWS_Connection(socket, that, function () {
 ...
 * @param {Function} [callback] will be added as "connection" listener
 */
NodeWS_Server.prototype.listen = function (port, host, callback) {
	var that = this
